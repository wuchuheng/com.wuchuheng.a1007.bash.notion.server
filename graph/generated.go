...
func (ec *executionContext) field_Mutation_createMessage_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewMessage2serverᚗnotionᚗa1007ᚗwuchuhengᚗcomᚋmᚋv2ᚋgraphᚋmodelᚐNewMessage(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createMessage(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMessage2ᚖserverᚗnotionᚗa1007ᚗwuchuhengᚗcomᚋmᚋv2ᚋgraphᚋmodelᚐMessage(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_messages(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Message)
	fc.Result = res
	return ec.marshalNMessage2ᚕᚖserverᚗnotionᚗa1007ᚗwuchuhengᚗcomᚋmᚋv2ᚋgraphᚋmodelᚐMessageᚄ(ctx, field.Selections, res)
}
	...
	return func(ctx context.Context) graphql.Marshaler {
		...
		case res, ok := <-resTmp.(<-chan *model.Message):
			...
			return graphql.WriterFunc(func(w io.Writer) {
				...
				w.Write([]byte{':'})
				ec.marshalNMessage2ᚖserverᚗnotionᚗa1007ᚗwuchuhengᚗcomᚋmᚋv2ᚋgraphᚋmodelᚐMessage(ctx, field.Selections, res).MarshalGQL(w)
				w.Write([]byte{'}'})
			})
		case <-ctx.Done():
			return nil
...
func (ec *executionContext) marshalNMessage2serverᚗnotionᚗa1007ᚗwuchuhengᚗcomᚋmᚋv2ᚋgraphᚋmodelᚐMessage(ctx context.Context, sel ast.SelectionSet, v model.Message) graphql.Marshaler {
	return ec._Message(ctx, sel, &v)
}

func (ec *executionContext) marshalNMessage2ᚕᚖserverᚗnotionᚗa1007ᚗwuchuhengᚗcomᚋmᚋv2ᚋgraphᚋmodelᚐMessageᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Message) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMessage2ᚖserverᚗnotionᚗa1007ᚗwuchuhengᚗcomᚋmᚋv2ᚋgraphᚋmodelᚐMessage(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMessage2ᚖserverᚗnotionᚗa1007ᚗwuchuhengᚗcomᚋmᚋv2ᚋgraphᚋmodelᚐMessage(ctx context.Context, sel ast.SelectionSet, v *model.Message) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNNewMessage2serverᚗnotionᚗa1007ᚗwuchuhengᚗcomᚋmᚋv2ᚋgraphᚋmodelᚐNewMessage(ctx context.Context, v interface{}) (model.NewMessage, error) {
